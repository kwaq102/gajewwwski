				...
				<div className="offer__box">
					<div className="offer__services-description">
						...
						<p className="offer__text">
							...
							Pomagam w wyborze domeny, hostingu oraz wdrażam stronę od A do Z.
							Dbam o SEO na każdym etapie, by Twoja strona była widoczna w
							wyszukiwarkach. Oferuję też wsparcie przy późniejszych zmianach,
							aktualizacji wtyczek oraz zabezpieczeniu witryny. Dodatkowo tworzę
							treści zgodne z SEO i optymalizuję grafiki, żeby Twoja strona była
							szybka i atrakcyjna.
						</p>
						<ButtonLink
